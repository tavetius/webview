...
const NavBar = ({
  ...
  const [isChecked, setIsChecked] = useState(userInfo.arrows_enabled);
  ...
  const toggleCheckbox = () => {
    setDashboardSettings(userInfo.token, userInfo.userProfileId, userInfo.is_dark, !isChecked, userInfo.board_theme, userInfo.pieces_theme);
          ...
          <div className="nav-header-info">
            ...
            <span className="user-name" id="user-account">
              ...
              >
                ...
                {userInfo.username} <sup style={{ marginRight: "10px" }}> &nbsp; new</sup>
              ...
              {isClickMenu ? <Portal>
                {isMenuOpen ? (
                  ...
                  (dropDownShown &&
                    <DropDownList data={dropDownShown == "BOARD_THEME" ? BOARD_THEME : PIECE_SET}
                      toggleMenu={toggleMenu} label={dropDownShown == "BOARD_THEME" ? "Board Theme" : "Piece Set"}
                      isShowTitle={true}
