...
import { captureException, captureMessage, captureEvent } from '@sentry/react';
      ...
      {enginesStockfishLc0.map((name, index) => {
        return (
          <div
            ...
            key={index}
            style={{
              display: servers && servers.constructor === Object && servers[name] && !initiateFullAnalysis ? 'none' : '',
            }}
          >
                    ...
                    {servers &&
                      ...
                      (!initiateFullAnalysis ? (
                        <button
                          ...
                          className={
                            loader ? 'analyze-button' : 'analyze-button-loader'
                          }
                          disabled={!loader}
                          onClick={() => {
                            handleOrderServer(
